    ...
    <div className="bg-white">
      ...
      <div className="relative bg-gray-900">
        ...
        <header className="z-10 fixed w-full">
          <nav aria-label="Top">
            {/* Top navigation */}
            {mostrar&&<div className="bg-gray-900">
            ...
            <div 
                className="backdrop-blur-xl backdrop-filter bg-opacity-10 bg-white border-gray-300 border-opacity-50"
                style={{backgroundColor: 'rgba(10,10,10, 0.4)', borderBottomWidth: '1px'}}
            >
